...
<p align="center">
  <img alt="Version 0.3.3" src="https://img.shields.io/badge/version-0.3.3-3f7f99?style=flat-square">
...
当前版本为 **0.3.3**，安装包可在 [Releases](../../releases/latest) 页面下载：
...
墨岛笔记目前专注于个人、本地的笔记与文档管理。`0.3.3` 暂不包含账户、云同步、多人协作、插件、移动端和知识图谱。
