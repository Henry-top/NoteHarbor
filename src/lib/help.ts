...
export const helpTopics: HelpTopic[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "粘贴或把文件拖到编辑器时，会作为附件保存并插入相对链接。TXT 也支持这三种模式。"
    ],
  ...
  },
  {
    id: "drag-pdf-txt",
    title: "拖拽、TXT 与 PDF",
    summary: "把文件放到正确的位置，并在应用内阅读 TXT 和 PDF。",
    steps: [
      "拖到资料库或侧栏文件夹时，文件会作为正式资料库文件导入该位置。",
      "拖到 Markdown/TXT 编辑器时，图片、PDF 和普通文件会作为附件并插入相对链接。",
      "TXT 保留 .txt 扩展名，并支持三种编辑模式、搜索、自动保存和历史。",
      "PDF 在正常标签页中预览，可缩放、跳页、选择文字和查找；也可以用默认软件打开。"
    ],
    tips: [
      "assets 只是外部附件的默认位置；把附件转为资料库文件不会移动文件，也不会破坏链接。",
      "文件夹右键菜单可以新建、导入、重命名、显示或移到系统废纸篓/回收站。"
    ],
    keywords: ["拖拽", "TXT", "PDF", "附件", "assets", "文件夹", "预览", "移动", "引用"]
  },
  {
    id: "files",
    title: "文件与数据安全",
